...
const STEPS = [
  ...
  },
  {
    ...
    color: "teal",
    description: "A deterministic data-quality audit flags issues, outliers, duplicates, and empty columns, with an AI-written summary of how clean the data is overall.",
  },
  {
    step: 3,
    title: "Features",
    icon: <IconSparkle />,
    color: "purple",
    description: "Compute KPIs from your Customer KPI Profile, or build new ones yourself straight from your data's own columns.",
  },
  {
    step: 4,
    title: "Analysis",
    icon: <IconGrid />,
    color: "amber",
    description: "Build breakdowns with interactive slicers, view as tables or charts, and get an AI-written executive summary of what matters most.",
  },
  {
    step: 5,
    title: "Report",
