// Small stroke-based icon set shared across pages, matching the style
// already used in FileUploadCard (24x24 viewBox, strokeWidth 1.6, currentColor).
...
export const IconSparkle = () => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path
      d="M12 3.5 13.7 9l5.3 1.7-5.3 1.7L12 18l-1.7-5.6-5.3-1.7 5.3-1.7L12 3.5Z"
      stroke="currentColor"
      strokeWidth="1.5"
...
export const IconWarnTriangle = () => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M12 4 21 20H3L12 4Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
    <path d="M12 10v4.2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    <circle cx="12" cy="17" r="0.9" fill="currentColor" />
  </svg>
);

export const IconShieldSearch = () => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="M12 3.5 19 6.2V11c0 4.8-3 8.3-7 9.5-4-1.2-7-4.7-7-9.5V6.2L12 3.5Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
    <circle cx="10.8" cy="10.6" r="2.3" stroke="currentColor" strokeWidth="1.5" />
    <path d="m12.6 12.4 1.9 1.9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const IconSearch = () => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
    ...
    <path d="m19 19-3.8-3.8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);
