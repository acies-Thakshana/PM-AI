...
No LLM involved here: duplicate/outlier detection has to be reliable, not a
plausible-sounding guess -- see audit_summary.py for the one place an LLM
narrates (never decides) these findings into a headline sentence.
